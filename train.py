...
from utils.general import labels_to_class_weights, increment_path, labels_to_image_weights, init_seeds, \
    ...
    check_requirements, print_mutation, set_logging, one_cycle, colorstr, set_seeds
...
def train(hyp, opt, device):
    ...
    if isinstance(hyp, str):
        with open(hyp, encoding='utf-8') as f:
            ...
            if cfg =='models/innovation/yolov5l+ISE+ConDown+Focal loss.yaml':
                hyp['fl_gamma']=1.5
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/innovation/yolov5l+ISE+ConDown+Focal loss.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/DUO.yaml', help='dataset.yaml path')
